...
/* harmony import */ var _core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core-5bacd579.js */ "./node_modules/ionicons/dist/esm-es5/core-5bacd579.js");
/* harmony import */ var _utils_cd124641_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils-cd124641.js */ "./node_modules/ionicons/dist/esm-es5/utils-cd124641.js");
...
var isValid = function (elm) {
    if (elm.nodeType === 1) {
        ...
        for (var i = 0; i < elm.attributes.length; i++) {
            ...
            if (Object(_utils_cd124641_js__WEBPACK_IMPORTED_MODULE_1__["i"])(val) && val.toLowerCase().indexOf('on') === 0) {
                return false;
            }
        }
...
var Icon = /** @class */ (function () {
    function Icon(hostRef) {
        Object(_core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__["r"])(this, hostRef);
    ...
    Icon.prototype.loadIcon = function () {
        var _this = this;
        if (this.isVisible) {
            var url_1 = Object(_utils_cd124641_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this);
            if (url_1) {
        ...
        if (!this.ariaLabel) {
            var label = Object(_utils_cd124641_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this.name, this.icon, this.mode, this.ios, this.md);
    ...
    Icon.prototype.render = function () {
        ...
        return (Object(_core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "img", class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color)), (_b = {}, _b["icon-" + this.size] = !!this.size, _b['flip-rtl'] = !!flipRtl && this.el.ownerDocument.dir === 'rtl', _b)) }, ((this.svgContent)
            ? Object(_core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "icon-inner", innerHTML: this.svgContent })
            : Object(_core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "icon-inner" }))));
    };
    ...
    Object.defineProperty(Icon.prototype, "el", {
        get: function () { return Object(_core_5bacd579_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this); },
        enumerable: true,
        configurable: true
    });
